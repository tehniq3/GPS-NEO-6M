 ...
 * ver. 4.1 - used just first button for incresed local time zone, second button used for change 12/24-hur format
 * ver. 4.2 - added debounce for buttons and stored value in EEPROM just after long time to prevent multiple writting
 * 
*/
